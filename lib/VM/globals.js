...
function createGlobalFunction(name, args, fn, varargs = false) {
  globals.set(
    ...
    new FunctionExpression(
      ...
      // todo: args should already be an array of FunctionArgumentExpression
      args.map(arg => new FunctionArgumentExpression(arg, new NilLiteral())),
      varargs
    )
  );
}
...
// panic
createGlobalFunction("panic", ["message"], (_, message) => {
