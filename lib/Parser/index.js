...
class Parser {
  ...
  _functionCall() {
    ...
    return new FunctionCall(new IdentifierExpression(identifier.text), args)
  }
  ...
  _function() {
    ...
    switch (next.symbol) {
      case LSCOPE:
        return new FunctionExpression(this._multiLineFunction(), args)
      default:
        return new FunctionExpression([new ReturnStatement(this._expression())], args)
    }
  }
